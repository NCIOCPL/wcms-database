IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[udf_GetSummaryTopLevelSectionID]') AND xtype in (N'FN', N'IF', N'TF'))
DROP FUNCTION [dbo].[udf_GetSummaryTopLevelSectionID]
GO

/****** Object:  User Defined Function dbo.udf_GetSummaryTopLevelSectionID    Script Date: 5/12/2004 2:31:14 PM ******/
CREATE FUNCTION [dbo].[udf_GetSummaryTopLevelSectionID]
(
