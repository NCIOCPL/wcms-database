...
and priority = 1
union
select '7DD04EC0-91DE-4EE7-BC99-CE79C8538F98', 'nciLandingPage', '/director', '/director'
order by 3
GO
...
drop procedure dbo.mig_msfolder
go
create procedure [dbo].[Mig_MSfolder]  
as  
BEGIN  

--	select distinct folder from microsites
--	where urlname is not null
--	union
--	select distinct folder + case when urlname is null then '' else '/'+ urlname END 
--	from 
--	(select  folder, urlname from microsites
--	group by folder, urlname
--	having count(*) > 1) a

create table #t (urlpath varchar(500))
	...
	insert into #t values ('/aboutnci/occp/overview')

insert into #t  values('/aboutnci/occp/ncipartnersinchina')
insert into #t  values('/aboutnci/occp/fundingopportunities')
insert into #t  values('/aboutnci/occp/activities')
insert into #t  values('/aboutnci/occp/contact')
insert into #t  values('/aboutnci/organization/olacpd/collaboration')
insert into #t  values('/aboutnci/organization/olacpd/training')
insert into #t  values('/aboutnci/organization/olacpd/researchnetwork')
insert into #t  values('/aboutnci/organization/olacpd/activities')
insert into #t  values('/aboutnci/organization/olacpd/about')
insert into #t  values('/aboutnci/recovery/recoveryfunding/awards')
insert into #t  values('/aboutnci/recovery/recoverynews/ncinewsarchive')
insert into #t  values('/aboutnci/recovery/recoverynews/highlightsarchive')
insert into #t  values('/aboutnci/recovery/recoveryobjectives')
insert into #t  values('/aboutnci/servingpeople/highlights')
insert into #t  values('/cancertopics/aya/coping')
insert into #t  values('/cancertopics/aya/reports')
insert into #t  values('/cancertopics/aya/resources')
insert into #t  values('/cancertopics/aya/survivorship')
insert into #t  values('/cancertopics/aya/treatment')
insert into #t  values('/cancertopics/aya/types')
insert into #t  values('/cancertopics/cancerlibrary/cancerspace/howitworks')
insert into #t  values('/cancertopics/cancerlibrary/cancerspace/questions')
insert into #t  values('/clinicaltrials/conducting/ncictrp/who-registers')
insert into #t  values('/clinicaltrials/conducting/ncictrp/how-to-register')




 select * from #t  
where urlpath not in 
( select urlpath  
 from urltree  
 where isend = 0  
 group by urlpath  )
