...
*	
*	Purpose:	
*	- Push Extracted data from CDRPreview to CDRLive	
*
*	Objects Used:
*
*	Change History:
...
BEGIN
	...
	IF @CleanOldData = 'Yes' 
	BEGIN
		EXEC  @r = CDRLiveGK.dbo.usp_ClearExtractedDrugInfoSummaryData @DocumentID, 'No' -- "NO" means do not Clear Document Properties
		IF (@@ERROR <> 0) or (@r <>0)
		BEGIN
	...
	INSERT INTO CDRLiveGK.dbo.DrugInfoSummary
		(
		DrugInfoSummaryID,
		Title,
		Description,
	...
	SELECT 	DrugInfoSummaryID,
		...
		@UpdateDate,
		@UpdateUserID
	FROM 	CDRPreviewGK.dbo.DrugInfoSummary
	...
	PRINT  '           DONE - Push data to DrugInfoSummary and related tables from PREVIEW to LIVE '
