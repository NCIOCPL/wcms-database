...
BEGIN
	...
	IF @CleanOldData = 'Yes' 
	BEGIN
		EXEC  @r = CDRPreviewGK.dbo.usp_ClearExtractedGeneticProfessionalData @DocumentID
		IF (@@ERROR <> 0) or (@r <> 0)
		BEGIN
	...
	INSERT INTO CDRPreviewGK..GenProf
		(
		GenProfID,
		ShortName,
		FirstName,
	...
	INSERT INTO CDRPreviewGK.dbo.GenProfCancerTypeSite
		(
		CancerTypeSiteID,
		CancerTypeSite,
		UpdateDate,
	...
	SELECT 	CancerTypeSiteID,
		...
		@UpdateDate,
		@UpdateUserID
	FROM 	CDRStagingGK.dbo.GenProfCancerTypeSite
	WHERE 	CancerTypeSiteID IN (
				SELECT CancerTypeSiteID 
				FROM CDRStagingGK.dbo.GenProfTypeOfCancer 
				WHERE GenProfID = @DocumentID
				) 
	...
	INSERT INTO CDRPreviewGK.dbo.GenProfFamilyCancerSyndrome
		(
	...
	SELECT 	FamilyCancerSyndromeID,
		...
		@UpdateDate,
		@UpdateUserID
	FROM 	CDRStagingGK.dbo.GenProfFamilyCancerSyndrome
	WHERE 	GenProfID = @DocumentID 	
	...
	INSERT INTO CDRPreviewGK.dbo.GenProfPracticeLocation
		(
		GenProfID,
		City,
		State,
	...
	SELECT 	GenProfID,
		...
		@UpdateDate,
		@UpdateUserID
	FROM 	CDRStagingGK.dbo.GenProfPracticeLocation
	WHERE 	GenProfID = @DocumentID 	
	...
	INSERT INTO CDRPreviewGK.dbo.GenProfTypeOfCancer
		(
		GenProfID,
		CancerTypeSiteID,
		FamilyCancerSyndromeID,
	...
	INSERT INTO CDRPreviewGK.dbo.DocumentXML
		(
		DocumentID,
		XML
		)
	SELECT 
		DocumentID,
		XML	
	FROM 	CDRStagingGK.dbo.DocumentXML
