IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[[dbo]].vw_EnglishSearchFilterView_old_243]') AND OBJECTPROPERTY(id, N'IsView') = 1)
DROP VIEW [dbo].[[dbo]].vw_EnglishSearchFilterView_old_243]
GO
