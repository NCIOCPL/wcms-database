IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[usp_PushNCIViewToProductionInScript]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[usp_PushNCIViewToProductionInScript]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[usp_PushNCIViewToProductionInScript] 
	(
		...
		BEGIN
			...
			BEGIN 
				...
				BEGIN
					...
					EXECUTE @ReturnStatus = [CancerGovStaging].[dbo].[usp_PushNCIViewToProductionInScript] 
