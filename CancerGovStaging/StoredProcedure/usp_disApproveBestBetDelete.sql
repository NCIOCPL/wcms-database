IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[usp_disApproveBestBetDelete]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[usp_disApproveBestBetDelete]
GO
SET ANSI_NULLS OFF
GO
...
**
*/
CREATE PROCEDURE [dbo].[usp_disApproveBestBetDelete] 
	(
	@CategoryID  uniqueidentifier,    -- View ID that was disapproved
...
BEGIN	
	...
	*/	
	...
	values
	(@sendID, @receiveID, 'Best Bet Delete Approval Request Denied', 'Best Bet Delete Approval Request Denied for ' + 
...
END
GO
GRANT EXECUTE ON [dbo].[usp_disApproveBestBetDelete] TO [webadminuser_role]
GO
