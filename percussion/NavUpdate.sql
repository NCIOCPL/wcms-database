...
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/about-cancer/causes-prevention', 'About Cancer', 'nciglobal,ncienglish-all,ncicancertopics', 'Causes and Prevention')
...
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/about-cancer/diagnosis-staging', 'About Cancer', 'nciglobal,ncienglish-all,ncicancertopics', 'Diagnosis and Staging')
...
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/research/resources', 'Research', 'nciglobal,ncienglish-all,nciresearch', 'RandD Resources')
...
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/grants-training', 'Grants and Training', 'nciglobal,ncienglish-all,nciresearch', 'Grants and Training Landing Page')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/grants-training/grants', 'Grants and Training', 'nciglobal,ncienglish-all,nciresearch', 'Research Projects Grants')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/grants-training/grants-process', 'Grants and Training', 'nciglobal,ncienglish-all,nciresearch', 'NCI Grants Process')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/grants-training/grants-management', 'Grants and Training', 'nciglobal,ncienglish-all,nciresearch', 'NCI Grants Management')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/grants-training/other-funding', 'Grants and Training', 'nciglobal,ncienglish-all,nciresearch', 'Other Funding')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/grants-training/training', 'Grants and Training', 'nciglobal,ncienglish-all,nciresearch', 'Funding for Training')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/news-events', 'News and Events', 'nciglobal,ncienglish-all,ncinews', 'News and Events Landing Page')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/news-events/press-releases', 'News and Events', 'nciglobal,ncienglish-all,ncinews', 'Press Releases')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/news-events/media-resources', 'News and Events', 'nciglobal,ncienglish-all,ncinews', 'Media Resources')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/news-events/events', 'News and Events', 'nciglobal,ncienglish-all,ncinews', 'Events')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/news-events/cancer-currents-blog', 'News and Events', 'nciglobal,ncienglish-all,ncinews', 'Cancer Current Blog')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/news-events/events/conferences', 'News and Events', 'nciglobal,ncienglish-all,ncinews', 'Conferences')
...
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/espanol/cancer/causas-prevencion', 'About Cancer - Spanish', 'nciglobal,ncispanish-all,ncielcancer', 'Causes and Prevention - Spanish')
...
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/espanol/cancer/diagnostico-estadificacion', 'About Cancer - Spanish', 'nciglobal,ncispanish-all,ncielcancer', 'Diagnosis and Staging - Spanish')
...
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/espanol/subvenciones-capacitacion', 'Grants and Training - Spanish', 'nciglobal,ncispanish-all', 'Grants and Training - Spanish')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/espanol/noticias', 'News and Events - Spanish', 'nciglobal,ncispanish-all,ncinoticias', 'News and Events Landing Page - Spanish')
insert into #t (url, channel, suite, [content-group]) values('www.cancer.gov/espanol/noticias/comunicados-de-prensa', 'News and Events - Spanish', 'nciglobal,ncispanish-all,ncinoticias', 'Press Releases - Spanish')
